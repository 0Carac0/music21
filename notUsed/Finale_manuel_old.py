...
263 = Détective Conan - Case Closed
...
while morceau == 0 :
    ...
    if morceau == '1':
        ...
        instruments_interdits = ['']
        sequence = 4
        path = '/home/pi/Desktop/Music21/midi/Pokemon - Gold vs Red.mid'
    elif morceau == '776':
        finesse = 0.03125 
        tempo = 180 # BPM
        instruments_interdits = ['']
