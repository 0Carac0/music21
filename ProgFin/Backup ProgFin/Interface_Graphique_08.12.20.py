...
class Blindtest_ImageScreen(Screen):
    ...
    def on_enter(self):
        ...
        if rep == rep1:
            ...
            # la réponse est fausse une croix est crée.
...
class BlindtestScreen(Screen):
    ...
    def on_enter(self):
        ...
        # On mets à un dnas la colonne déjà jouer la musique sélectionner
        ...
        # Aléatoirement choisi parmis ce qui reste si il n'y a pas assez on prend ceux déjà utiliser sans que ce soit le même que la réponse
